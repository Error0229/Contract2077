...
contract ERC721 is IERC721, ERC165 {
    ...
    function safeTransferFrom(address _from, address _to, uint256 _tokenId, bytes memory data) external payable override{
        require (_from == msg.sender && _to != address(0) && _ownerOf[_tokenId] != address(0));
    ...
    function transferFrom(address _from, address _to, uint256 _tokenId) external payable override {
        ...
        require (owner == msg.sender || _approvals[_tokenId] == msg.sender || _operatorApprovals[owner][msg.sender] == true);
    ...
    function approve(address _approved, uint256 _tokenId) external payable override {
        address owner = _ownerOf[_tokenId];
        require (owner != address(0));
        require (msg.sender == owner || _operatorApprovals[owner][msg.sender] == true);
